...
class __TwigTemplate_66dc7f6732d89e1cd977944df440a806 extends Template
{
    private $source;
    private $macros = [];
...
($context["icon"] ?? null) && ($context["icon_position"] ?? null)) &&  !($context["icon_only"] ?? null))) ? (("icon-" . $this->sandbox->ensureToStringAllowed(($context["icon_position"] ?? null), 31, $this->source))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "themes/contrib/bootstrap/templates/input/input--button--split.html.twig", "/opt/drupal/web/themes/contrib/bootstrap/templates/input/input--button--split.html.twig");
    }
